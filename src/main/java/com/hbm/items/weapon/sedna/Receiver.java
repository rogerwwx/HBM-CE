...
public class Receiver {
    ...
    protected Vec3d projectileOffset_DNA = new Vec3d(0, 0, 0);
    protected Vec3d projectileOffsetScoped_DNA = new Vec3d(0, 0, 0);
    ...
    public Vec3d getProjectileOffset(ItemStack stack) {			return XWeaponModManager.eval(this.projectileOffset_DNA, stack, O_PROJECTILEOFFSET, this, parent.index); }
    public Vec3d getProjectileOffsetScoped(ItemStack stack) {	return XWeaponModManager.eval(this.projectileOffsetScoped_DNA, stack, O_PROJECTILEOFFSETSCOPED, this, parent.index); }

    public BiFunction<ItemStack, ItemGunBaseNT.LambdaContext, Boolean> getCanFire(ItemStack stack) {	return XWeaponModManager.eval(this.canFire_DNA, stack, FUN_CANFIRE, this, parent.index); }
    public BiConsumer<ItemStack, ItemGunBaseNT.LambdaContext> getOnFire(ItemStack stack) {			return XWeaponModManager.eval(this.onFire_DNA, stack, CON_ONFIRE, this, parent.index); }
    public BiConsumer<ItemStack, ItemGunBaseNT.LambdaContext> getRecoil(ItemStack stack) {			return XWeaponModManager.eval(this.onRecoil_DNA, stack, CON_ONRECOIL, this, parent.index); }
    ...
    public Receiver offset(double f, double u, double s) {			this.projectileOffset_DNA = new Vec3d(f, u, s); this.projectileOffsetScoped_DNA = new Vec3d(f, u, 0);	return this; }
    public Receiver offsetScoped(double f, double u, double s) {	this.projectileOffsetScoped_DNA = new Vec3d(f, u, s);	return this; }
