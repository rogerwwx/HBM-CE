...
public class XWeaponModManager {
    ...
    public static void init() {
        ...
        new WeaponModDefinition(GunFactory.EnumModGeneric.DURA_DAMAGE).addMod(duraGuns, new WeaponModGenericDamage(104));
        new WeaponModDefinition(GunFactory.EnumModGeneric.DURA_DURA).addMod(duraGuns, new WeaponModGenericDurability(105));
        new WeaponModDefinition(GunFactory.EnumModGeneric.DESH_DAMAGE).addMod(deshGuns, new WeaponModGenericDamage(106));
        new WeaponModDefinition(GunFactory.EnumModGeneric.DESH_DURA).addMod(deshGuns, new WeaponModGenericDurability(107));
        new WeaponModDefinition(GunFactory.EnumModGeneric.WSTEEL_DAMAGE).addMod(wsteelGuns, new WeaponModGenericDamage(108));
        new WeaponModDefinition(GunFactory.EnumModGeneric.WSTEEL_DURA).addMod(wsteelGuns, new WeaponModGenericDurability(109));
        new WeaponModDefinition(GunFactory.EnumModGeneric.FERRO_DAMAGE).addMod(ferroGuns, new WeaponModGenericDamage(110));
        new WeaponModDefinition(GunFactory.EnumModGeneric.FERRO_DURA).addMod(ferroGuns, new WeaponModGenericDurability(111));
        new WeaponModDefinition(GunFactory.EnumModGeneric.TCALLOY_DAMAGE).addMod(tcalloyGuns, new WeaponModGenericDamage(112));
        new WeaponModDefinition(GunFactory.EnumModGeneric.TCALLOY_DURA).addMod(tcalloyGuns, new WeaponModGenericDurability(113));
        new WeaponModDefinition(GunFactory.EnumModGeneric.BIGMT_DAMAGE).addMod(bigmtGuns, new WeaponModGenericDamage(114));
        new WeaponModDefinition(GunFactory.EnumModGeneric.BIGMT_DURA).addMod(bigmtGuns, new WeaponModGenericDurability(115));
        ...
        new WeaponModDefinition(GunFactory.EnumModSpecial.NICKEL).addMod(new Item[] {ModItems.gun_n_i_4_n_i}, new WeaponModNickel(ID_NI4NI_NICKEL, "COIN1"));
        new WeaponModDefinition(GunFactory.EnumModSpecial.DOUBLOONS).addMod(new Item[] {ModItems.gun_n_i_4_n_i}, new WeaponModNickel(ID_NI4NI_DOUBLOONS, "COIN2"));
    ...
    public static ItemStack[] getUpgradeItems(ItemStack stack, int cfg) {
        ...
        int[] modIds = Objects.requireNonNull(stack.getTagCompound()).getIntArray(KEY_MOD_LIST + cfg);
    ...
    public static void install(ItemStack stack, int cfg, ItemStack... mods) {
        ...
        for(ItemStack mod : mods) {
            ...
            RecipesCommon.ComparableStack comp = new RecipesCommon.ComparableStack(mod);
    ...
    public static void uninstall(ItemStack stack, int cfg) {
        if(stack.hasTagCompound()) {
            Objects.requireNonNull(stack.getTagCompound()).removeTag(KEY_MOD_LIST + cfg);
    ...
    public static IWeaponMod modFromStack(ItemStack gun, ItemStack mod, int cfg) {
        ...
        IWeaponMod newMod = def.modByGun.get(new RecipesCommon.ComparableStack(gun).makeSingular()); //shift clicking causes the gun to have stack size 0!
    ...
    public static class WeaponModDefinition {
        ...
        public WeaponModDefinition addMod(Item gun, IWeaponMod mod) { return addMod(new RecipesCommon.ComparableStack(gun), mod); }
        public WeaponModDefinition addMod(Item[] gun, IWeaponMod mod) { for(Item item : gun) addMod(new RecipesCommon.ComparableStack(item), mod); return this; }
        ...
        public WeaponModDefinition addDefault(IWeaponMod mod) {
            return addMod((RecipesCommon.ComparableStack) null, mod);
        }
    }
}
